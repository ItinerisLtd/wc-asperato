...
class MissingWooCommerce
{
    ...
    public function printAdminNotice(): void
    {
        ...
        // Translators: %1$s - WC Asperato URL %2$s - WooCommerce URL.
        $messagePattern = __(
            '<a href="%1$s">WC Asperato</a> depends on the last version of <a href="%2$s">WooCommerce</a> to work!',
            'wc-asperato'
        );
        $message = sprintf(
            $messagePattern,
            'https://github.com/ItinerisLtd/wc-asperato',
